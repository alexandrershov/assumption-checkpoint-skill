...
The current design is intentionally compact: it starts with a risk router, keeps routine checkpoints internal, and treats checkpoints as decision gates rather than prose the user must read.
